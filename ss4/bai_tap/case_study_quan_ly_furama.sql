create database if not exists case_study_quan_ly_khu_nghi_duong_furama;
use case_study_quan_ly_khu_nghi_duong_furama;
create table kieu_thue(
	ma_kieu_thue int auto_increment primary key,
	ten_kieu_thue enum('hour','day','month','year')
);
create table vi_tri(
...
create table dich_vu(
    ...
    dien_tich int,
    chi_phi_thue int,
    so_nguoi_toi_da tinyint,
    tieu_chuan_phong enum('vip', 'normal'),
    mo_ta_tien_nghi_khac varchar(100),
    dien_tich_ho_boi int,
    so_tang tinyint,
    ma_kieu_thue int,
    ma_loai_dich_vu int,
    constraint fk_kieu_xe foreign key(ma_kieu_thue) references kieu_thue(ma_kieu_thue),
...
create table Villa(
    ...
    chi_phi_thue double,
    so_luong_nguoi tinyint,
    tieu_chuan_phong varchar(40),
    mo_ta_tien_nghi_khac varchar(50),
    dien_tich_ho_boi int,
    so_tang int,
    ma_kieu_thue int,
    constraint fk_kieu_thue foreign key (ma_kieu_thue) references kieu_thue(ma_kieu_thue) ON DELETE CASCADE
);
create table House(
	ten_dich_vu varchar(100),
    dien_tich_su_dung double,
...
VALUES
  (1, 'Nguyễn Thị Hào', '1970-11-07', 0, '643431213', '0954233362', 'thihao07@gmail.com', '23 Nguyễn Hoàng, Đà Nẵng', 5),
...
SELECT 
    ...
    COUNT(DISTINCT hd.ma_khach_hang) AS so_khach_dat_phong
FROM hop_dong hd
